<%@page import="co.yedam.users.serviceImpl.UserServiceImpl"%>
<%@page import="co.yedam.users.service.UserService"%>
<%@page import="co.yedam.users.service.UserVO"%>
...
<div id="joinContainer">
	...
	<form action="editUser.do" method="POST">
				...
				<div class="row">
					<div class="col-sm-8 ">
						<input style="border: none" id="userid" type="text" name="userid"
							placeholder="아이디" value="${userId}" readonly="readonly">
		...
		<div id="button">
			<input type="submit" id="submit" value="회원수정"
