...
<nav class="navbar navbar-expand-sm bg-body-tertiary">
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="navbar-nav mx-auto">
				...
				<li class="nav-item"><a class="nav-link" href="menu.do"> 메뉴
				</a></li>
			...
			<ul class="navbar-nav ml-auto">
				<li><a href="cart.do" class="btn position-relative"
					style="--bs-btn-border-color: none"> <svg
  ...
  <path
						...
						<P>장바구니</P> <span id="cartAmounts" class="position-absolute top-20 start-80 badge rounded-pill bg-danger">
