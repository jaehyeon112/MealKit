...
<!-- <section class="py-5">
    <div class="container px-4 px-lg-5 mt-5"> -->
        <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center" id="aa">
...
<!-- <section class="py-5">
    <div class="container px-4 px-lg-5 mt-5"> --> 
        <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center" id="div1" style="display: none;">
            <c:forEach items="${list }" var="vo" >
                <c:choose>
                    <c:when test="${vo.menuCount == 0}">
                        <input type="hidden" name="menuId" value="${vo.menuId}">
...
<!-- <section class="py-5">
    <div class="container px-4 px-lg-5 mt-5"> -->
        <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center" id="div2" style="display: none;">
            <c:forEach items="${list }" var="vo">
                <c:choose>
                    <c:when test="${vo.menuCount == 0}">
                        <input type="hidden" name="menuId" value="${vo.menuId}">
...
<!-- <section class="py-5">
    <div class="container px-4 px-lg-5 mt-5"> -->
        <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center" id="div3" style="display: none;">
            <c:forEach items="${list }" var="vo">
                <c:choose>
                    <c:when test="${vo.menuCount == 0}">
                        <input type="hidden" name="menuId" value="${vo.menuId}">
