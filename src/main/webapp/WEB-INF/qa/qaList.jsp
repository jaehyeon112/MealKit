...
<section id="myContainer">
	<div id="content" class="myWrap">
		...
		<div class="rightCon">
			...
			<div class="tabMenu">
				<ul id="ulTabMenu">
					<li id="liTabMenu"><a href="qa.do" id="liTabMenuB "style=" font-size:24px">1:1 문의
							작성</a></li>
					<li id="liTabMenu"><a href="qaList.do" id="liTabMenuA">1:1
							문의 내역</a></li>
				</ul>
			</div>
			<h4>1:1문의 목록</h4>
				...
				<tbody>
					<c:forEach items="${list }" var="vo">
						<tr>
							...
							<td>${vo.qaNo }</td>
							<c:choose>
							<c:when test="${userId == vo.userId || userId == 'admin' }">
