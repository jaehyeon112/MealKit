...
body, div, dl, dt, dd, ul, ol, li, h1, h2, h3, h4, h5, h6, code, form,
	fieldset, legend, textarea, p, blockquote, table, th, td, input, select,
	textarea, button {
	margin: 0;
	padding: 0;
			...
			<div class="#!">
				...
				<div class="prd_list row">
									...
									<div class="top_wrap">
										...
										<div class="top_wrap--right">
											...
											<span><input name="orderDetailNumber"
												value="${vo.orderDetailNumber }" type="hidden"></input>주문상세번호:
												${vo.orderDetailNumber } |</span>
									...
									<div class="etc_info">
										<div class="rating_wrap">
											<span class="rating_star"> <span class="star">
												...
												</span> <!-- backgorund image 활성화 영역 (20%에 한개씩 점수가 채워 집니다.) -->
											</span>
											</span>
										</div>
										<!-- 190610_수정 -->
										<div class="user_id">
											<a><span> | ${vo.userId }</span></a>
                    ...
                    <span class="hide">구매 횟수 : </span>구매 3회
									...
									<input type="text" name="reviewContent" class="text"
										placeholder="리뷰를 작성해주세요" /> <input
										style="padding-top: 10px" type="file" name="reviewImage"
										accept="image/*" value="${vo.reviewImage }" />
									<div class="buttons">
